...
export default function Code() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Ingrese código de verificación</Text>

      <TextInput placeholder="Código" placeholderTextColor="#777" style={styles.input} />

      <Pressable style={styles.button} onPress={() => router.replace("/change")}>
