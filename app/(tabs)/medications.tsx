    ...
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.cardInfo}>
          <Text style={styles.cardTitle}>Antiparasitario</Text>
          <Text style={styles.cardDetail}>Dosis: 1 tableta</Text>
          <Text style={styles.cardDetail}>Fecha: 25/04/2026</Text>
...
const styles = StyleSheet.create({
  ...
  buttonSmall: { backgroundColor: PRIMARY, padding: 8, borderRadius: 8, alignItems: "center", marginTop: 8, width: 100 },
